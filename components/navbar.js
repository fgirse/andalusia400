...
const [toggleDropdown, setToggleDropdown] = useState(false);
  ...
  return (
    ...
    <nav className="h-24 bg-gray-700 flex-between w-[100vw] mb-16 pt-3">
          ...
          <div className="flex flex-wrap items-center justify-around w-full lg:w-auto">
                ...
                <Disclosure.Button
                  ...
                  className="px-2 py-1 mx-auto text-gray-500 rounded-md lg:hidden hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none dark:text-gray-300 dark:focus:bg-trueGray-700">
                  <svg
                ...
                <Disclosure.Panel className="flex flex-wrap w-full my-5 lg:hidden">
                  <>
                    {navigation.map((item, index) => (
                      <Link key={index} href="/" className="w-full px-4 py-2 -ml-4 font-archidought text-amber-500 rounded-md dark:text-gray-300 hover:text-gray-100 hover:bg-gray-600 focus:text-indigo-500 focus:bg-indigo-100 dark:focus:bg-gray-800 focus:outline-none">
                          {item}
                      </Link>
                    ))}
