    ...
    return (
        <div>
            <div className="bg-blue-600                                                                                                                                 container flex justify-center mx-auto pt-16">
                <div>
                    <p className="font-archidaught text-green-500 text-lg text-center font-normal pb-3">ANDALUSIA TEAM</p>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-red-500">
                                ...
                                <div className="px-6 mt-16">
                                    ...
                                    <p className="text-center text-gray-600 text-base pt-3 font-normal">Nadine ist eine ausgesprochen erfahrene Kennerin des Immobilienmarktes in Andalusien.... </p>
